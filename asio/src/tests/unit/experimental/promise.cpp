...
void promise_tester()
{
  ...
  static_assert(asio::is_async_operation<decltype(p)>::value, "promise is async_op");
...
void test_cancel()
{
  ...
  {
    auto p = test_cancel_impl(tim, ec, asio::experimental::use_promise);
  }
