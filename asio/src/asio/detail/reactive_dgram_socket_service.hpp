...
public:
  ...
  public:
    sendto_handler(impl_type impl, Demuxer& demuxer, const void* data,
        size_t length, const socket_address& address, Handler handler,
      ...
      completion_context& context)
  {
    ...
    reactor_.start_write_op(impl, sendto_handler<Handler>(impl, demuxer_,
  ...
  public:
    recvfrom_handler(impl_type impl, Demuxer& demuxer, void* data,
        size_t max_length, socket_address& address, Handler handler,
        completion_context& context)
      : impl_(impl),
        demuxer_(demuxer),
        data_(data),
  ...
  {
    demuxer_.operation_started();
    reactor_.start_read_op(impl, recvfrom_handler<Handler>(impl, demuxer_,
