...
#ifndef ASIO_CORO_COMPLETION_HANDLER_HPP
#define ASIO_CORO_COMPLETION_HANDLER_HPP
...
{
  coro_completion_handler(std::coroutine_handle<Promise> h,
                          std::optional<std::tuple<Args...>> &result)
          : self(h), result(result) {}
  coro_completion_handler(coro_completion_handler && ) = default;
  std::coroutine_handle<Promise> self;
...
inline void coro_interpret_result(std::tuple<> && args)
{
}

template<typename ... Args>
auto coro_interpret_result(std::tuple<Args...> && args)
{
...
auto coro_interpret_result(std::tuple<Arg> && args)
{
...
#endif //ASIO_CORO_COMPLETION_HANDLER_HPP
