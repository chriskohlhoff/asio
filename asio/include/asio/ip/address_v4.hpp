...
public:
   ...
   * @li <tt>to_uint() == 0</tt>.
   */
  ASIO_CONSTEXPR_CXX20 address_v4() ASIO_NOEXCEPT
  {
    addr_.s_addr = 0;
  }
   ...
   */
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL explicit address_v4(const bytes_type& bytes);

  /// Construct an address from an unsigned integer in host byte order.
  /**
   * Initialises the @c address_v4 object such that <tt>to_uint() == addr</tt>.
   */
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL explicit address_v4(uint_type addr);

  /// Copy constructor.
  ASIO_CONSTEXPR address_v4(const address_v4& other) ASIO_NOEXCEPT
    : addr_(other.addr_)
  {
  }
  ...
  /// Move constructor.
  ASIO_CONSTEXPR address_v4(address_v4&& other) ASIO_NOEXCEPT
    : addr_(other.addr_)
  {
  }
  ...
  ASIO_CONSTEXPR_CXX14 address_v4& operator=(const address_v4& other) ASIO_NOEXCEPT
  {
    addr_ = other.addr_;
    return *this;
  }
  ...
  ASIO_CONSTEXPR_CXX14 address_v4& operator=(address_v4&& other) ASIO_NOEXCEPT
  {
    addr_ = other.addr_;
    return *this;
  }
  ...
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL uint_type to_uint() const ASIO_NOEXCEPT;
   ...
   */
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL bool is_loopback() const ASIO_NOEXCEPT;
   ...
   */
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL bool is_unspecified() const ASIO_NOEXCEPT;
   ...
   */
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL bool is_multicast() const ASIO_NOEXCEPT;

  /// Compare two addresses for equality.
  ASIO_CONSTEXPR friend bool operator==(const address_v4& a1,
   ...
   */
  ASIO_CONSTEXPR_CXX20 friend bool operator<(const address_v4& a1,
      const address_v4& a2) ASIO_NOEXCEPT
  {
   ...
   */
  ASIO_CONSTEXPR_HO_CXX20 static address_v4 any() ASIO_NOEXCEPT
  {
    return address_v4();
  }
   ...
   */
  static ASIO_CONSTEXPR_HO_CXX20 address_v4 loopback() ASIO_NOEXCEPT
  {
   ...
   */
  static ASIO_CONSTEXPR_HO_CXX20 address_v4 broadcast() ASIO_NOEXCEPT
  {
 ...
 * @relates address_v4
 */
ASIO_CONSTEXPR_HO_CXX20 inline address_v4 make_address_v4(const address_v4::bytes_type& bytes)
{
 ...
 * @relates address_v4
 */
ASIO_CONSTEXPR_HO_CXX20 inline address_v4 make_address_v4(address_v4::uint_type addr)
{
