...
public:
  /// Default constructor.
  ASIO_CONSTEXPR_HO_CXX20 network_v4() ASIO_NOEXCEPT
    : address_(),
      prefix_length_(0)
  {
  }
  ...
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL network_v4(const address_v4& addr,
  ...
  /// Copy constructor.
  ASIO_CONSTEXPR network_v4(const network_v4& other) ASIO_NOEXCEPT
  ...
  /// Move constructor.
  ASIO_CONSTEXPR network_v4(network_v4&& other) ASIO_NOEXCEPT
  ...
  ASIO_CONSTEXPR_CXX20 network_v4& operator=(const network_v4& other) ASIO_NOEXCEPT
  {
    address_ = other.address_;
    prefix_length_ = other.prefix_length_;
    return *this;
  ...
  ASIO_CONSTEXPR_CXX20 network_v4& operator=(network_v4&& other) ASIO_NOEXCEPT
  {
    address_ = ASIO_MOVE_CAST(address_v4)(other.address_);
    prefix_length_ = other.prefix_length_;
    return *this;
  ...
  ASIO_CONSTEXPR_CXX20 address_v4 address() const ASIO_NOEXCEPT
  {
    return address_;
  }
  ...
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL address_v4 netmask() const ASIO_NOEXCEPT;

  /// Obtain an address object that represents the network address.
  ASIO_CONSTEXPR_HO_CXX20 address_v4 network() const ASIO_NOEXCEPT
  {
  ...
  ASIO_CONSTEXPR_HO_CXX20 address_v4 broadcast() const ASIO_NOEXCEPT
  {
  ...
  ASIO_CONSTEXPR_HO_CXX20 network_v4 canonical() const ASIO_NOEXCEPT
  {
  ...
  ASIO_CONSTEXPR_HO_CXX20 ASIO_DECL bool is_subnet_of(const network_v4& other) const;
  ...
  ASIO_CONSTEXPR_CXX20 friend bool operator==(const network_v4& a, const network_v4& b)
  {
 ...
 * @relates address_v4
 */
ASIO_CONSTEXPR_HO_CXX20 inline network_v4 make_network_v4(
