...
ASIO_NODISCARD ASIO_CONSTEXPR reset_cancellation_state_0_t
...
{
  template <typename F>
  ASIO_CONSTEXPR reset_cancellation_state_1_t(ASIO_MOVE_ARG(F) filter)
...
/// of the current coroutine.
template <typename Filter>
ASIO_NODISCARD ASIO_CONSTEXPR reset_cancellation_state_1_t<
...
/// of the current coroutine.
template <typename InFilter, typename OutFilter>
ASIO_NODISCARD ASIO_CONSTEXPR reset_cancellation_state_2_t<
