...
#ifndef ASIO_PROCESS_WINDOWS_WITH_TOKEN_LAUNCHER_HPP
#define ASIO_PROCESS_WINDOWS_WITH_TOKEN_LAUNCHER_HPP
...
#include "asio/process/windows/with_token_launcher.hpp"
...
struct with_token_launcher : default_launcher
{
  ...
  auto operator()(ExecutionContext & context,
                  ...
                  const typename constraint<is_convertible<
                         ...
                         filesystem::path >::type & executable,
                  Args && args,
                  Inits && ... init) -> basic_process<typename ExecutionContext::executor_type>
  {
...
#endif //ASIO_PROCESS_WINDOWS_WITH_TOKEN_LAUNCHER_HPP
