...
#ifndef ASIO_DETAIL_APPLE_NW_SOCKET_CONNECT_OP_HPP
#define ASIO_DETAIL_APPLE_NW_SOCKET_CONNECT_OP_HPP
...
{
public:
  ASIO_DEFINE_HANDLER_PTR(apple_nw_socket_connect_op);
...
#endif // ASIO_DETAIL_APPLE_NW_SOCKET_CONNECT_OP_HPP
