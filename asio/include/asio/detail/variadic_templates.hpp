...
# define ASIO_VARIADIC_TTYPES(n) ASIO_VARIADIC_TTYPES_##n

# define ASIO_VARIADIC_TTYPES_1 T1
# define ASIO_VARIADIC_TTYPES_2 T1, T2
# define ASIO_VARIADIC_TTYPES_3 T1, T2, T3
# define ASIO_VARIADIC_TTYPES_4 T1, T2, T3, T4
# define ASIO_VARIADIC_TTYPES_5 T1, T2, T3, T4, T5
