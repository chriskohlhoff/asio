...
void ionotify_reactor::notify_fork(asio::execution_context::fork_event fork_ev)
{
...
void ionotify_reactor::cancel_ops(
    socket_type descriptor, ionotify_reactor::per_descriptor_data&)
{
  mutex::scoped_lock lock(mutex_);
...
void ionotify_reactor::cancel_ops_by_key(socket_type descriptor,
    ionotify_reactor::per_descriptor_data&, int op_type, void* cancellation_key)
{
  mutex::scoped_lock lock(mutex_);
  op_queue<operation> ops;
...
void ionotify_reactor::deregister_descriptor(socket_type descriptor,
    ionotify_reactor::per_descriptor_data& /*d*/, bool /*cancel_ops*/)
{
  mutex::scoped_lock lock(mutex_);
...
socket_type ionotify_reactor::fdmap::set(
    reactor_op_queue<socket_type>& operations, op_queue<operation>& /*ops*/,
    op_types op)
{
...
void ionotify_reactor::fdmap::perform(reactor_op_queue<socket_type>& operations,
...
void ionotify_reactor::run(long usec, op_queue<operation>& ops)
{
  ...
  for (int i = 0; i < max_select_ops; ++i)
  {
    ...
    socket_type maxfd = fdmap_.set(op_queue_[i], ops, static_cast<op_types>(i));
...
void ionotify_reactor::cancel_ops_unlocked(
