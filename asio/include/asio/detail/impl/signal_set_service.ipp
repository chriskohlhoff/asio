...
# if defined(ASIO_HAS_IO_URING)
      (void)read_descriptor;
      io_uring_service_.register_io_object(io_object_data_);
      io_uring_service_.start_op(io_uring_service::read_op,
          io_object_data_, new pipe_read_op, false);
# else // defined(ASIO_HAS_IO_URING)
...
# if defined(ASIO_HAS_IO_URING)
  (void)read_descriptor;
  service->io_uring_service_.register_io_object(service->io_object_data_);
  service->io_uring_service_.start_op(io_uring_service::read_op,
      service->io_object_data_, new pipe_read_op, false);
# else // defined(ASIO_HAS_IO_URING)
