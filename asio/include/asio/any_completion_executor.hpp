...
public:
  ...
  /// Copy constructor.
  ASIO_DECL any_completion_executor(const any_completion_executor& e) ASIO_NOEXCEPT;

#if defined(ASIO_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)
  /// Move constructor.
  ASIO_DECL any_completion_executor(any_completion_executor&& e) ASIO_NOEXCEPT;
...
template <>
ASIO_DECL any_completion_executor any_completion_executor::require(
