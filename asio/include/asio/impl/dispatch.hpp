...
dispatch(ASIO_MOVE_ARG(CompletionTokens)... tokens)
{
  ...
  ex.dispatch(ASIO_MOVE_CAST(chain_type)(chain), allocator);
...
dispatch(ASIO_MOVE_ARG(Executor) executor,
...
#define ASIO_PRIVATE_DISPATCH_DEF(n) \
  ...
  /**/
  ASIO_VARIADIC_GENERATE(ASIO_PRIVATE_DISPATCH_DEF)
#undef ASIO_PRIVATE_DISPATCH_DEF
