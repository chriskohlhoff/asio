...
post(ASIO_MOVE_ARG(CompletionTokens)... tokens)
{
  ...
  ex.post(ASIO_MOVE_CAST(chain_type)(chain), allocator);
...
post(ASIO_MOVE_ARG(Executor) executor,
...
#define ASIO_PRIVATE_POST_DEF(n) \
  ...
  /**/
  ASIO_VARIADIC_GENERATE(ASIO_PRIVATE_POST_DEF)
#undef ASIO_PRIVATE_POST_DEF
