...
#ifndef ASIO_BASIC_DATAGRAM_SOCKET_IPP
#define ASIO_BASIC_DATAGRAM_SOCKET_IPP
...
template <typename Service>
inline basic_datagram_socket<Service>::basic_datagram_socket(
    asio::io_service& io_service, const endpoint_type& endpoint)
...
inline std::size_t basic_datagram_socket<Service>::send(
...
inline void basic_datagram_socket<Service>::async_send(
...
template <typename Service>
template <typename Const_Buffers>
inline std::size_t basic_datagram_socket<Service>::send_to(
    const Const_Buffers& buffers, const endpoint_type& destination)
{
...
template <typename Service>
template <typename Const_Buffers, typename Handler>
inline void basic_datagram_socket<Service>::async_send_to(
    const Const_Buffers& buffers, const endpoint_type& destination,
    Handler handler)
{
...
inline std::size_t basic_datagram_socket<Service>::receive(
...
inline void basic_datagram_socket<Service>::async_receive(
...
template <typename Service>
template <typename Mutable_Buffers>
inline std::size_t basic_datagram_socket<Service>::receive_from(
...
template <typename Service>
template <typename Mutable_Buffers, typename Handler>
inline void basic_datagram_socket<Service>::async_receive_from(
    const Mutable_Buffers& buffers, endpoint_type& sender_endpoint,
    Handler handler)
{
...
#endif // ASIO_BASIC_DATAGRAM_SOCKET_IPP
